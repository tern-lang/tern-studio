...
public class StructGenerator extends PropertyGenerator {

   public StructGenerator(Domain domain, Entity entity, Property property) {
   ...
   public void generateGetter(CodeAppender appender) {
      ...
      appender.append("   public %sBuilder %s() {\n", constraint, name);
