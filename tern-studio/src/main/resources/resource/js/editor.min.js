...
function(){return e.getEditorPanel().getSelectedText()};a.isEditorChanged=d;a.isEditorChangedForPath=h;a.scrollEditorToPosition=m;a.updateProjectTabOnChange=function(){e.getEditorPanel().on("input",function(){var a=e.getEditorResource(),a=e.getHistoryForResource(a),b=e.getEditorPanel().getValue();a.touchHistory(b);q(e.getEditorResource().getResourcePath())})};a.formatEditorSource=function(){var a=e.getEditorPanel().getValue(),b=e.getEditorResource().getFilePath();u.ajax({contentType:"text/plain",
