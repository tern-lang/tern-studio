...
var ActionScriptHighlightRules = function() {
    ...
    this.$rules = { start: 
       [ 
			//{ token: 'support.class.snapscript.2',
         ...
         //{ token: 'support.function.snapscript.2',
         ...
         { token: 'punctuation.definition.string.begin.snapscript.2',
           regex: '"',
           push: 
            [ { token: 'punctuation.definition.string.end.snapscript.2',
                regex: '"',
                next: 'pop' },
              { token: 'constant.character.escape.snapscript.2',
                regex: '\\\\.' },
              { defaultToken: 'string.quoted.double.snapscript.2' } ] },
         { token: 'punctuation.definition.string.begin.snapscript.2',
           regex: '\'',
           push: 
            [ { token: 'punctuation.definition.string.end.snapscript.2',
              ...
              { token: 'constant.character.escape.snapscript.2',
                regex: '\\\\.' },
              { defaultToken: 'string.quoted.single.snapscript.2' } ] },
        { token: 'punctuation.definition.string.begin.snapscript.2',
           regex: '`',
           push: 
            [ { token: 'punctuation.definition.string.end.snapscript.2',
         ...
         { token: 'punctuation.definition.comment.snapscript.2',
           regex: '/\\*',
           push: 
            [ { token: 'punctuation.definition.comment.snapscript.2',
                regex: '\\*/',
                next: 'pop' },
              { defaultToken: 'comment.block.snapscript.2' } ] },
         { token: 'punctuation.definition.comment.snapscript.2',
           regex: '//.*$',
           push_: 
            [ { token: 'comment.line.double-slash.snapscript.2',
                regex: '$',
                next: 'pop' },
              { defaultToken: 'comment.line.double-slash.snapscript.2' } ] },
         { token: 'keyword.operator.snapscript.2',
           regex: '\\binstanceof\\b' },
         { token: 'keyword.operator.symbolic.snapscript.2',
           regex: '[-!%&*+=/?:]' },
         { token: 
            [ 'meta.preprocessor.snapscript.2',
              'punctuation.definition.preprocessor.snapscript.2',
              'meta.preprocessor.snapscript.2' ],
           regex: '^([ \\t]*)(#)([a-zA-Z]+)' },
//         { token: 
//            [ 'storage.type.function.snapscript.2',
//              'meta.function.snapscript.2',
//              'entity.name.function.snapscript.2',
//              'meta.function.snapscript.2',
//              'punctuation.definition.parameters.begin.snapscript.2' ],
//           regex: '\\b(function)(\\s+)([a-zA-Z_]\\w*)(\\s*)(\\()',
//           push: 
//            [ { token: 'punctuation.definition.parameters.end.snapscript.2',
//                regex: '\\)',
//                next: 'pop' },
//              { token: 'variable.parameter.function.snapscript.2',
//                regex: '[^,)$]+' },
//              { defaultToken: 'meta.function.snapscript.2' } ] },
         { token: 
            [ 'storage.type.class.snapscript.2',
              'meta.class.snapscript.2',
              'entity.name.type.class.snapscript.2',
              'meta.class.snapscript.2',
