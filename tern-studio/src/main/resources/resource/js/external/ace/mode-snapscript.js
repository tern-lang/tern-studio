...
var ActionScriptHighlightRules = function() {
    ...
    this.$rules = { start: 
       [ 
			//{ token: 'support.class.ternscript.2',
         ...
         //{ token: 'support.function.ternscript.2',
         ...
         //{ token: 'support.constant.ternscript.2',
         //  regex: '\\b(?:__proto__|__resolve|_accProps|_alpha|_changed|_currentframe|_droptarget|_flash|_focusrect|_framesloaded|_global|_height|_highquality|_level|_listeners|_lockroot|_name|_parent|_quality|_root|_rotation|_soundbuftime|_target|_totalframes|_url|_visible|_width|_x|_xmouse|_xscale|_y|_ymouse|_yscale)\\b' },        
       	{ token: 'keyword.control.ternscript.2',
         ...
         { token: 'constant.language.ternscript.2',
           regex: '\\b(?:null|undefined|true|false)\\b' },
         { token: 'constant.numeric.ternscript.2',
           regex: '\\b(?:0(?:x|X|b|B)[0-9a-fA-F]*|(?:[0-9]+\\.?[0-9]*|\\.[0-9]+)(?:(?:e|E)(?:\\+|-)?[0-9]+)?)(?:L|l|UL|ul|u|U|F|f|d|D)?\\b' },
         { token: 'punctuation.definition.string.begin.ternscript.2',
           regex: '"',
           push: 
            [ { token: 'punctuation.definition.string.end.ternscript.2',
                regex: '"',
                next: 'pop' },
              { token: 'constant.character.escape.ternscript.2',
                regex: '\\\\.' },
              { defaultToken: 'string.quoted.double.ternscript.2' } ] },
         { token: 'punctuation.definition.string.begin.ternscript.2',
           regex: '\'',
           push: 
            [ { token: 'punctuation.definition.string.end.ternscript.2',
              ...
              { token: 'constant.character.escape.ternscript.2',
                regex: '\\\\.' },
              { defaultToken: 'string.quoted.single.ternscript.2' } ] },
        { token: 'punctuation.definition.string.begin.ternscript.2',
           regex: '`',
           push: 
            [ { token: 'punctuation.definition.string.end.ternscript.2',
         ...
         { token: 'punctuation.definition.comment.ternscript.2',
           regex: '/\\*',
           push: 
            [ { token: 'punctuation.definition.comment.ternscript.2',
                regex: '\\*/',
                next: 'pop' },
              { defaultToken: 'comment.block.ternscript.2' } ] },
         { token: 'punctuation.definition.comment.ternscript.2',
           regex: '//.*$',
           push_: 
            [ { token: 'comment.line.double-slash.ternscript.2',
                regex: '$',
                next: 'pop' },
              { defaultToken: 'comment.line.double-slash.ternscript.2' } ] },
         { token: 'keyword.operator.ternscript.2',
           regex: '\\binstanceof\\b' },
         { token: 'keyword.operator.symbolic.ternscript.2',
           regex: '[-!%&*+=/?:]' },
         { token: 
            [ 'meta.preprocessor.ternscript.2',
              'punctuation.definition.preprocessor.ternscript.2',
              'meta.preprocessor.ternscript.2' ],
           regex: '^([ \\t]*)(#)([a-zA-Z]+)' },
//         { token: 
//            [ 'storage.type.function.ternscript.2',
//              'meta.function.ternscript.2',
//              'entity.name.function.ternscript.2',
//              'meta.function.ternscript.2',
//              'punctuation.definition.parameters.begin.ternscript.2' ],
//           regex: '\\b(function)(\\s+)([a-zA-Z_]\\w*)(\\s*)(\\()',
//           push: 
//            [ { token: 'punctuation.definition.parameters.end.ternscript.2',
//                regex: '\\)',
//                next: 'pop' },
//              { token: 'variable.parameter.function.ternscript.2',
//                regex: '[^,)$]+' },
//              { defaultToken: 'meta.function.ternscript.2' } ] },
         { token: 
            [ 'storage.type.class.ternscript.2',
              'meta.class.ternscript.2',
              'entity.name.type.class.ternscript.2',
              'meta.class.ternscript.2',
              'storage.modifier.extends.ternscript.2',
              'meta.class.ternscript.2',
              'entity.other.inherited-class.ternscript.2' ],
