...
function B(a,c){var b=k.FileEditor.currentEditorState(),d=c.split(/[ ]+/),b={breakpoints:b.getBreakpoints(),arguments:d,project:h.Common.getProjectName(),resource:b.getResource().getFilePath(),source:b.getSource(),debug:a?!0:!1};g.EventBus.sendEvent("EXECUTE",b)}e.openChildWindow=function(a,c){var b=window.document.location.port,d=window.document.location.protocol+"//"+window.document.location.hostname;0<=b-parseFloat(b)+1&&(d=d+":"+b);g.EventBus.sendEvent("LAUNCH",{address:d+a})};e.searchTypes=function(){l.DialogBuilder.createListDialog(function(a,
c,b){I(a,function(a,c){for(var e=[],d=0;d<a.length;d++){var f=window.document.location.pathname,g=-1!==f.indexOf(";debug",f.length-6),k="/project/"+a[d].project,f="\x3ci style\x3d'opacity: 0.5'\x3e"+a[d].module+"\x3ci\x3e",l="";a[d].extra&&(l="\x3ci style\x3d'opacity: 0.5'\x3e"+a[d].extra+"\x3ci\x3e");g&&(k+=";debug");if(u(a[d].extra))var g=a[d].module,n=a[d].name,k=k+("#"+C(a[d].extra,g+"."+n));else if(g=a[d].resource,g=a[d].extra?h.Common.stringStartsWith(g,"java.")||h.Common.stringStartsWith(g,
"jdk."):!1,g)var g=a[d].module,n=a[d].name,r=g+"."+n,g=h.Common.stringReplaceText(a[d].extra,"\\","/"),n=z(r),r=A(r),k=k+("#"+("/decompile/"+g+"/"+n+"/"+r+".java"));else k+="#"+m.FileTree.cleanResourcePath(a[d].resource);e.push([{text:a[d].name+"\x26nbsp;\x26nbsp;"+f,link:k,line:0,style:"module"==a[d].type?"moduleNode":"typeNode"},{text:a[d].resource+"\x26nbsp;\x26nbsp;"+l,link:k,line:0,style:"resourceNode"}])}b(e,c)})},null,"Search Types")};e.searchOutline=function(){l.DialogBuilder.createListDialog(function(a,
c,b){J(a,function(a,c){for(var d=[],e=0;e<a.length;e++){var f=a[e],g=f.type.toLowerCase(),k="\x3ci style\x3d'opacity: 0.5'\x3e"+f.constraint+"\x3ci\x3e",l=A(f.declaringClass),n="\x3ci style\x3d'opacity: 0.5'\x3e"+z(f.declaringClass)+"\x3ci\x3e",r=f.resource,q=f.line,t=null;u(f.libraryPath)&&f.declaringClass?(t="/project/"+h.Common.getProjectName()+"#"+C(f.libraryPath,f.declaringClass),q=null):r=m.FileTree.cleanResourcePath("/resource/"+h.Common.getProjectName()+r);d.push([{text:f.name+"\x26nbsp;\x26nbsp;"+
k,resource:r,link:t,line:q,style:"function"==g?"functionNode":"propertyNode"},{text:l+"\x26nbsp;\x26nbsp;"+n,resource:r,link:t,line:q,style:"resourceNode"}])}b(d,c)})},null,"Search Outline")};e.replaceTokenInFiles=function(a,c,b){E(a,b,c,function(a){for(var c=k.FileEditor.currentEditorState(),b=0;b<a.length;b++){var d=a[b],d=m.FileTree.createResourcePath("/resource/"+d.project+"/"+d.resource);c.getResource().getResourcePath()==d.getResourcePath()&&y.FileExplorer.openTreeFile(d.getResourcePath(),function(){})}})};
e.searchFiles=function(a){D(!1,a)};e.searchAndReplaceFiles=function(a){D(!0,a)};e.findFileNames=function(){l.DialogBuilder.createListDialog(function(a,c,b){K(a,function(a,c){for(var d=[],e=0;e<a.length;e++){var f=a[e],g=window.document.location.pathname,g=-1!==g.indexOf(";debug",g.length-6),h="/project/"+f.project;g&&(h+=";debug");h+="#"+m.FileTree.cleanResourcePath(f.resource);d.push([{text:f.text,name:f.name,link:h,style:"resourceNode"}])}return b(d,c)})},null,"Find Files")};e.openTerminal=function(a){m.FileTree.isResourceFolder(a.getFilePath())&&
(a={project:h.Common.getProjectName(),resource:a.getFilePath(),terminal:!0},g.EventBus.sendEvent("EXPLORE",a))};e.exploreDirectory=function(a){m.FileTree.isResourceFolder(a.getFilePath())&&(a={project:h.Common.getProjectName(),resource:a.getFilePath(),terminal:!1},g.EventBus.sendEvent("EXPLORE",a))};e.folderExpand=function(a){a={project:h.Common.getProjectName(),folder:a};g.EventBus.sendEvent("FOLDER_EXPAND",a)};e.folderCollapse=function(a){a={project:h.Common.getProjectName(),folder:a};g.EventBus.sendEvent("FOLDER_COLLAPSE",
a)};e.pingProcess=function(){g.EventBus.isSocketOpen()&&g.EventBus.sendEvent("PING",h.Common.getProjectName())};e.uploadFileTo=function(a,c,b){c=m.FileTree.createResourcePath(c);c=m.FileTree.cleanResourcePath(c.getFilePath()+"/"+a);console.log("source: "+a+" destination: "+c);a={project:h.Common.getProjectName(),name:a,to:c,data:b,dragAndDrop:!0};g.EventBus.sendEvent("UPLOAD",a)};e.isDragAndDropFilePossible=function(a,c){return!0};e.dragAndDropFile=function(a,c){var b=a.getResource(),d=c.getResource(),
