...
g,"// Count not find "+a,c,d,f)}function h(a,c){var b;b=(b=a.getContentType())&&f.Common.stringStartsWith(b,"image")?!0:!1;b?(b=a.getDownloadURL(),window.open(b,"_blank").focus()):(b=a.getContentType())&&("application/json"==b||"application/x-javascript"==b||"application/javascript"==b?0:f.Common.stringStartsWith(b,"application")||f.Common.stringStartsWith(b,"image")||!f.Common.stringStartsWith(b,"text"))?window.location.href=a.getDownloadURL():v.FileEditor.updateEditor(a);c()}function t(a){return f.Common.stringEndsWith(a,
".json")||f.Common.stringEndsWith(a,".js")||f.Common.stringEndsWith(a,".xml")||f.Common.stringEndsWith(a,".project")||f.Common.stringEndsWith(a,".classpath")||f.Common.stringEndsWith(a,".index")}function x(a,c,b,d){"runScript"==c?k(a.getResourcePath(),function(){e.Command.runScript()}):"debugScript"==c?k(a.getResourcePath(),function(){e.Command.debugScript()}):"createArchive"==c?(c=n.FileTree.createResourcePath("/"+f.Common.getProjectName()+".jar"),e.Command.createArchive(c,a)):"newFile"==c?e.Command.newFile(a):
