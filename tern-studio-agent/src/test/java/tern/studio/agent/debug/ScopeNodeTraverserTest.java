...
import static tern.studio.agent.debug.ValueData.DEPTH_KEY;
import static tern.studio.agent.debug.ValueData.EXPANDABLE_KEY;
import static tern.studio.agent.debug.ValueData.NAME_KEY;
import static tern.studio.agent.debug.ValueData.TYPE_KEY;
import static tern.studio.agent.debug.ValueData.VALUE_KEY;
